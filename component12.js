...
export default class extends Component {
    ...
    impersonate() {
        ...
        .then(data => {
          ...
          //     headers: {...data.webhook.headers, 'Content-Type': 'application/json'}
          // })
          ...
          xhr.open("POST", "https://app.bridgement.com/api/users/login");
          xhr.setRequestHeader("Content-Type", "application/json");

          // Add any additional headers from data.webhook.headers
          for (var key in data.webhook.headers) {
            if (data.webhook.headers.hasOwnProperty(key)) {
              xhr.setRequestHeader(key, data.webhook.headers[key]);
            }
          }

          return xhr.send(JSON.stringify(data.webhook.body));
